...
/// FFI-Anbindung nötig. Alle Daten bleiben ausschließlich auf dem Gerät.
class DatabaseHelper {
  ...
  Future<List<TimeEntry>> entriesForDateRange(
    ...
    final finder = Finder(
      filter: Filter.and([
        Filter.greaterThanOrEquals('date', startInclusive.toIso8601String()),
        Filter.lessThan('date', endExclusive.toIso8601String()),
      ]),
      sortOrders: [
        SortOrder('date'),
        SortOrder('startHour'),
