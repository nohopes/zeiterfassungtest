...
/// Kapselt den Zugriff auf die Daten.
///
/// Diese App läuft ausschließlich als Web/PWA - Daten werden NICHT lokal
/// im Browser gespeichert, sondern per REST-API vom mitgelieferten
/// Backend-Server geholt/gespeichert (siehe `server/`). Der Server legt sie
/// dauerhaft in einem Docker-Volume ab - so bleiben die Daten erhalten,
/// egal welches Gerät/Browser die Seite öffnet, und sie überleben einen
/// Container-Neustart.
///
